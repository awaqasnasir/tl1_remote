...
private static final Logger LOG = LoggerFactory.getLogger(Tl1Provider.class);
  ...
  public static boolean loadNodes(String path) throws FileNotFoundException,IOException{
	  Messages.initialize();
	...
	// The name of the file to open.
      ...
      String line = null;
          ...
          while((line = bufferedReader.readLine()) != null) {
        	  ...
        	  writeToDeviceRegistry(deviceInfo[0], deviceInfo[1]);
        	  if(!ConnectionEstablisher.getInstance().connect(deviceInfo[0],deviceInfo[1])){
      			Messages.setRELOAD_DEVICES_FAILED_MESSAGE("cannot made connection with "+deviceInfo[0]+","+deviceInfo[1]);
      			success=false;
      		}
